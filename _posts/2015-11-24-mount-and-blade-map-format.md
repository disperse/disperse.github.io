...
I spent a couple evenings writing a world map generator for Mount and Blade Warband and wanted to pass on what I have learned about the map format in case it is of use to any other modders.
...
The last three numbers ( 0 0 3 **4 48 3** ) are the indices of the vertexes that define the location of the three points of the face. So for this example you would look at lines 5, 49, and 4 (remember, the first line is the # of vertices) to locate the vertices associated with the face.
